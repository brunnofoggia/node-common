import { Brackets, ObjectLiteral, ObjectType, OrderByCondition, SelectQueryBuilder, WhereExpressionBuilder } from 'typeorm';

import { Cursor, CursorParam, Order, PagingResult } from 'typeorm-cursor-pagination/lib/Paginator';
import { atob, btoa, encodeByType, decodeByType, pascalToUnderscore } from 'typeorm-cursor-pagination/lib/utils';
...
export default class Paginator<Entity extends ObjectLiteral> {
    ...
    public constructor(protected entity: ObjectType<Entity>, protected paginationKeys: Extract<keyof Entity, string>[]) {}
    ...
    protected appendPagingQuery(builder: SelectQueryBuilder<Entity>): SelectQueryBuilder<Entity> {
    ...
    protected getPagingResult(queryBuilder) {
